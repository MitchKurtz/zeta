...
% 2.) As the number of steps used in the approximation increases, the accuracy of the approximation increases*
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
addpath('./Tools')
clc;clear;format long g
testInputValues= {};
testInputValues{1,1} = 0.3 + 0.2532i;
testInputValues{2,1} = 0.4 - 0.2352i;
testInputValues{3,1} = 0.5 + 14.1347251417346937904572519835625i;
testInputValues{4,1} = 0.7 + 52.6i;
testInputValues{5,1} = 0.852352 + 0.0025489i;
testInputValues{6,1} = 0.95 + 1203i;
testInputValues{7,1} = 1.4235 + 5.2456i;
testInputValues{8,1} = 2 + 0i;
testInputValues{9,1} = 3.2 + 57i;
testInputValues{10,1} = 4.3 + 24i;
...
for ind = 1:size(testInputValues,1)
    ...
    % Calculate Zeta Function Using Kurtz Approximation (Defaults to 10000000 steps)
